<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Hesabını kalıcı olarak sil.') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Hesabınız bir kere kalıcı olarak silindiğinde tüm bilgileriniz kaybolacaktır.Kaybetmek istemediğiniz bilgilerinizin yedeğini alınız.') }}
        </div>
